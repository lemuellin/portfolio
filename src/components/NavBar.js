    ...
    return (
        <div className=" fixed top-0 h-12 w-screen m-0 flex justify-center items-center bg-primary shadow-md">
            <nav className="flex items-center justify-between flex-wrap font-redhat p-4">
                ...
                <div id="menuID" ref={menuRef} className={(menu ? " flex " : " hidden ") + " fixed top-12 flex-col rounded-xl bg-slate-200 px-12 py-6 right-0 sm:right-10 lg:flex lg:flex-row lg:py-0 lg:px-0 lg:bg-transparent lg:top-auto gap-4 font-redhat font-bold items-center" }>
